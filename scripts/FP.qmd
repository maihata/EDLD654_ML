...
Ridge and Elastic Net showed the best performance (R2 = 0.309). LASSO regression performed slightly worse (R2= 0.281), but all three performed substantially better than the mean-only baseline (R2 = –0.004).
...
-   The AQ-10 uses a cut-off score of 6, but I chose not to create a binary outcome because modeling the continuous score offered more nuance and avoided oversimplifying already limited data.

-   The dataset is highly skewed, and I do not know who was able or motivated to access this online screener, so the sample is not representative of a full population at all.
...
-   I struggled with the ethical implications of applying ML. I question whether participants consented to secondary use of their responses. Running models requires not just methodological care but also ethical reflection about data ownership, informed consent, and the risks of misinterpretation.

![](images/whosedata.jpeg){fig-align="center" width="50%"}
